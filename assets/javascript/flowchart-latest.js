...
!function(root, factory) {
    ...
    function(module, exports, __webpack_require__) {
        ...
        Symbol.prototype.getAttr = function(attName) {
            ...
            switch (this.symbolType) {
              case "start": fromNodeId = this.symbol.node.id; break;
              case "end": fromNodeId = this.symbol.node.id; break;
              case "operation": fromNodeId = this.symbol.node.id; break;
              case "subroutine": fromNodeId = this.symbol.node.id; break;
              case "inputoutput": fromNodeId = this.text.node.id.slice(0,-1);break;
              case "condition": fromNodeId = this.text.node.id.slice(0,-1);break;
            }

            // toNodeId generation
            switch (symbol.symbolType) {
              case "start": toNodeId = symbol.symbol.node.id;break;
              case "end": toNodeId = symbol.symbol.node.id;break;
              case "operation": toNodeId = symbol.symbol.node.id;break;
              case "subroutine": toNodeId = symbol.symbol.node.id;break;
              case "inputoutput": toNodeId = symbol.text.node.id.slice(0,-1);break;
              case "condition": toNodeId = symbol.text.node.id.slice(0,-1);break;
            }

            var relationLineClass = {fromNodeId:fromNodeId,toNodeId:toNodeId};
            ...
            if (origin && "bottom" !== origin || !isOnSameColumn || !isUnder) if (origin && "right" !== origin || !isOnSameLine || !isRight) if (origin && "left" !== origin || !isOnSameLine || !isLeft) if (origin && "right" !== origin || !isOnSameColumn || !isUpper) if (origin && "right" !== origin || !isOnSameColumn || !isUnder) if (origin && "bottom" !== origin || !isLeft) if (origin && "bottom" !== origin || !isRight) if (origin && "right" === origin && isLeft) line = drawLine(relationLineClass,this.chart, right, [ {
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.rightStart = !0, symbol.topEnd = !0, maxX = right.x + lineLength / 2; else if (origin && "right" === origin && isRight) line = drawLine(relationLineClass,this.chart, right, [ {
                x: symbolTop.x,
                y: right.y
            }, {
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.rightStart = !0, symbol.topEnd = !0, maxX = right.x + lineLength / 2; else if (origin && "bottom" === origin && isOnSameColumn && isUpper) line = drawLine(relationLineClass,this.chart, bottom, [ {
                x: bottom.x,
                ...
                symbolLeft.x < left.x && (diffX = symbolLeft.x - lineLength / 2), line = drawLine(relationLineClass,this.chart, left, [ {
                    x: diffX,
                    y: left.y
                }, {
                    x: diffX,
            ...
            } else "left" === origin && (line = drawLine(relationLineClass,this.chart, left, [ {
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.leftStart = !0, symbol.topEnd = !0, maxX = left.x); else line = drawLine(relationLineClass,this.chart, bottom, [ {
                x: bottom.x,
                y: bottom.y + lineLength / 2
            }, {
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.bottomStart = !0, symbol.topEnd = !0, maxX = bottom.x + (bottom.x - symbolTop.x) / 2; else line = this.leftEnd && isUpper ? drawLine(relationLineClass,this.chart, bottom, [ {
                x: bottom.x,
                y: bottom.y + lineLength / 2
            }, {
                x: bottom.x + (bottom.x - symbolTop.x) / 2,
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text) : drawLine(relationLineClass,this.chart, bottom, [ {
                x: bottom.x,
                y: symbolTop.y - lineLength / 2
            }, {
                x: symbolTop.x,
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.bottomStart = !0, symbol.topEnd = !0, maxX = bottom.x + (bottom.x - symbolTop.x) / 2; else line = drawLine(relationLineClass,this.chart, right, [ {
                x: right.x + lineLength / 2,
                y: right.y
            }, {
                x: right.x + lineLength / 2,
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.rightStart = !0, symbol.topEnd = !0, maxX = right.x + lineLength / 2; else line = drawLine(relationLineClass,this.chart, right, [ {
                x: right.x + lineLength / 2,
                y: right.y
            }, {
                x: right.x + lineLength / 2,
                ...
                x: symbolTop.x,
                y: symbolTop.y
            } ], text), this.rightStart = !0, symbol.topEnd = !0, maxX = right.x + lineLength / 2; else line = drawLine(relationLineClass,this.chart, left, symbolRight, text),
            this.leftStart = !0, symbol.rightEnd = !0, maxX = symbolRight.x; else line = drawLine(relationLineClass,this.chart, right, symbolLeft, text),
            this.rightStart = !0, symbol.leftEnd = !0, maxX = symbolLeft.x; else line = drawLine(relationLineClass,this.chart, bottom, symbolTop, text),
  ...
  \************************************/
    ...
    function(module, exports) {
        ...
        function drawLine(relationLineClass,chart, from, to, text) {
            var i, len;
